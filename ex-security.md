...
```
:arrow_right: This annotation specifies to the container that it should use the HTTP basic access authentication mechanism, it will be made available as an CDI enabled bean. The *realmName* pass in parameter will be used in the *WWW-Authenticate* header.
